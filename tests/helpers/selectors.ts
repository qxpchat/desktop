...
export const TID = {
  ...
  settingsProfileAvatar: '[data-testid="settings-profile__avatar"]',
  settingsProfileAvatarInput: '[data-testid="settings-profile__avatar__file-input"]',
  settingsProfileAvatarMenuChange: '[data-testid="settings-profile__avatar__menu-change"]',
  settingsProfileAvatarMenuRemove: '[data-testid="settings-profile__avatar__menu-remove"]',
  ...
  onboardingWelcomeProxy: '[data-testid="onboarding-welcome__proxy"]',
  onboardingWelcomeProxyHost: '[data-testid="onboarding-welcome__proxy-host"]',
  onboardingProxyDialog: '[data-testid="onboarding-proxy-dialog"]',
  onboardingProxyDialogInput: '[data-testid="onboarding-proxy-dialog__input"]',
  onboardingProxyDialogSave: '[data-testid="onboarding-proxy-dialog__save"]',
  onboardingProxyDialogClear: '[data-testid="onboarding-proxy-dialog__clear"]',
  onboardingProxyDialogError: '[data-testid="onboarding-proxy-dialog__error"]',
  onboardingSignupScan: '[data-testid="onboarding-signup-scan"]',
  onboardingSignupScanPaste: '[data-testid="onboarding-signup-scan__paste-clipboard"]',
  onboardingSignupScanError: '[data-testid="onboarding-signup-scan__error"]',
  ...
  onboardingManualAdvancedToggle: '[data-testid="onboarding-manual__advanced-toggle"]',
  onboardingManualSmtpUser: '[data-testid="onboarding-manual__smtp-user"]',
  onboardingManualSmtpPassword: '[data-testid="onboarding-manual__smtp-password"]',
